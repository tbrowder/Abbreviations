...
B<NOTE: THIS VERSION IS API 2 AND HAS VERY DIFFERENT FEATURES COMPARED TO THE ORIGINAL API.>
...
A I<String> (C<S>) is the string formed by joining the B<List> by a single space.
